package org.apache.hadoop.examples.hao;
...
public class HaoGenHiveData extends Configured implements Tool {

  public static final boolean DEBUG_MODE = true;

  private static final Log log = LogFactory.getLog(HaoGenHiveData.class.getName());
  
  public static void main(String[] args) throws Exception {

    DataOptions options = new DataOptions(args);
    HaoGenHiveData haogen = new HaoGenHiveData(options);
    haogen.generate();
  ...
  HaoGenHiveData(DataOptions options) {
...
//          reporter.incrCounter(HiBench.Counters.BYTES_DATA_GENERATED, 8+value.getLength());
  ...
  private void createRankingsTableDirectly() throws IOException, URISyntaxException {
    ...
    JobConf job = new JobConf(HaoGenHiveData.class);
